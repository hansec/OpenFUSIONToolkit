...
# tokamaker_set_cond_eigs(tMaker_ptr,neigs,cond_eigs,error_str)
tokamaker_set_cond_eigs = ctypes_subroutine(oftpy_lib.tokamaker_set_cond_eigs,
    [c_void_p, ctypes_numpy_array(numpy.int32,1), ctypes_numpy_array(numpy.float64,2), c_char_p])

# tokamaker_get_cond_weights(tMaker_ptr,weights,error_str)
