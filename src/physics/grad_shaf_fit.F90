...
use oft_gs, only: gs_eq, gs_dflux, gs_itor_nl, gs_psi2r, &
  ...
  gs_get_cond_weights, gs_set_cond_weights, gs_get_cond_scales
...
REAL(r8), OPTIONAL, INTENT(in) :: coil_wt(:)!< Needs docs
LOGICAL, OPTIONAL, INTENT(in) :: fitF0 !< Needs docs
LOGICAL, OPTIONAL, INTENT(in) :: fixedCentering !< Needs docs
REAL(r8), OPTIONAL, POINTER, INTENT(in) :: nonax_corr(:,:) !< Needs docs
!---
