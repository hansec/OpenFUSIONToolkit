...
!
TYPE(oft_ml_fem_type), POINTER, PUBLIC :: ML_oft_lagrange
TYPE(oft_ml_fem_type), POINTER, PUBLIC :: ML_oft_h1,ML_h1grad
TYPE(oft_ml_fem_type), POINTER, PUBLIC :: ML_oft_hcurl
TYPE(oft_ml_fem_comp_type), POINTER, PUBLIC :: ML_hcurl_grad,ML_oft_vlagrange
!
