...
!--- Full H(Curl) space
CALL oft_hcurl_grad_setup(xmhd_ML_hcurl,xmhd_ML_H1,xmhd_ML_hcurl_grad,xmhd_ML_H1grad,minlev=-1)
...
!!
!! The gauge is transformed using a \ref oft_hcurl_grad_operators::hcurl_grad_divout "divergence cleaning"
